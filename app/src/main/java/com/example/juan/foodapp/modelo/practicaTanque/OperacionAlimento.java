...
public class OperacionAlimento {
    ...
    public double calcularDensidadAlimento(double temperatura){
        ...
        double grasa = (0.92559*exponente1-4.1757*exponente2);
    ...
    public static double calcularCpAgua(double temperatura){
        return (4176.2-((0.090864*temperatura)+(0.0054731*temperatura*temperatura)));
    }

    public static double calcularConductividadAgua(double temperatura){
        return (0.57109+((0.0017625*temperatura)-(0.0000067376*temperatura*temperatura)));
    }

    public static double calcularDensidadAgua(double temperatura){
        return (997.18+((0.0031439*temperatura)-(0.0037574*temperatura*temperatura)));
    }

    public static double calcularViscosidadAgua(double temperatura){
    ...
    public static double calcularExpancionTermicaAgua(double temperaturaChaqueta){
